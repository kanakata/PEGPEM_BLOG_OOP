        ...
        <div class="pagtop">
            ...
            <?php if ($moreCategoriesData['pages_number'] > 1): ?>
                <div class="pagination">
                    ...
                    ?>
                    <a href="?p=more<?= isset($_GET['v']) ? "&v=" . $_GET['v'] : "" ?><?= isset($_GET['category']) ? "&category=" . $_GET['category'] : "" ?>&page=<?= $prev_page ?>" class="<?php echo $prev_class; ?>">Previous</a>

                    <?php for ($i = 1; $i <= $moreCategoriesData['pages_number']; $i++): ?>
                        <?php $active_class = $i == $moreCategoriesData['page'] ? 'active' : ''; ?>
                        <a href="?p=more<?= isset($_GET['v']) ? "&v=" . $_GET['v'] : "" ?><?= isset($_GET['category']) ? "&category=" . $_GET['category'] : "" ?>&page=<?= $i ?>" class="<?php echo $active_class; ?>"><?php echo $i; ?></a>
                    <?php endfor; ?>
                    <?php
                    ...
                    ?>
                    <a href="?p=more<?= isset($_GET['v']) ? "&v=" . $_GET['v'] : "" ?><?= isset($_GET['category']) ? "&category=" . $_GET['category'] : "" ?>&page=<?= $next_page ?>" class="<?php echo $next_class; ?>">Next</a>
                </div>
            <?php endif; ?>
        ...
        <div class="contentholder2">
            ...
            <?php foreach ($moreCategoriesData['content'] as $info): ?>
                <a href="?p=contentpage&id=<?= htmlspecialchars(Router::Mask_content($info['id'])) ?>" class="blog">
                    ...
                    <div class="content">
                        <h3><?php echo htmlspecialchars($info['author']) ?>. <?php echo htmlspecialchars($info['date']) ?> <span><?php echo htmlspecialchars($info['likes']) ?> likes 👍</span></h3>
